...
import { userContext } from "./fakeStore";
...
export function Fakeproduct({ addtoCart }) {
    ...
    let SearchedString = useContext(userContext);
        ...
        <div className="d-flex flex-wrap justify-content-center m-3">
            {
                products.filter(items => {
                   return  SearchedString === ""|| items.title.toLowerCase().includes(SearchedString.toLowerCase())
                })
                .map(product => (
